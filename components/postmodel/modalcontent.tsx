...
const Modalcontent = ({post,coments}) => {
        ...
        <div className="modal_content">
              ...
              <div className="other_content">
                  <div className="modal_othertop">
                      <img  className="modal_othertop-avatar" src={imageUrl+postt.user.avatar} width="40px" height="40px" alt="" />
                       <div className="modal_othertop_username">{postt.user.name} {postt.user.surename}</div> 
                  </div>
              </div>
          </div>
    );
